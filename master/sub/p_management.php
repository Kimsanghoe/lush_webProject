    ...
    <div class="container body">
        <div class="main_container">
                ...
                <div class="left_col scroll-view">
                  ...
                  <div class="profile clearfix">
                    ...
                    <div class="profile_info">
                        <?php
                          if(empty($_SESSION["userId"])){		//로그인 안된상태
                        ?>
                            <form action="../login.php" method="post" class="login">
                              <h2> ID &nbsp; : </h2><input type="text" name="id"><br>
                              <h2> PW : </h2><input type="password" name="pw"><br>
                              <br>
            ...
            <div class="right_col" role="main">
                <div class="row" style="display: line-block;">
                        ...
                        <div class="table_box">
                          <table>
                            ...
                            <tr>
                              ...
                              <td>
                                <input type="text" name="p_add_stock" value="<?=$p_add_stock?>">
                              </td>
                              <td>
                                <input type="text" name="p_add_img1" value="<?=$p_add_img1?>">
                              </td>
                              <td>
                                <input type="text" name="p_add_img2" value="<?=$p_add_img2?>">
                              </td>
                              <td>
                                <input type="text" name="p_add_img3" value="<?=$p_add_img3?>">
                              </td>
