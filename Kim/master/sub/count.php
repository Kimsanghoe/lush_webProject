<?php
    ...
    switch($_SESSION["site_set"]) {
        ...
        case 'new':
            ...
            $numRecords = $PDO->query("select count(*) from product where p_rd > DATE_ADD(now(), INTERVAL -30 DAY)")->fetchColumn();
            break;
        ...
        case 'bath':
            ...
            $numRecords = $PDO->query("select count(*) from product where (c_code=1 or c_code=2 or c_code=3 or c_code=4)")->fetchColumn();
            break;
        ...
        case 'body':
            ...
            $numRecords = $PDO->query("select count(*) from product where (product.c_code=12 or product.c_code=13 or product.c_code=14 or product.c_code=15 or product.c_code=16 or product.c_code=17)")->fetchColumn();
            break;
        ...
        case 'shower':
            ...
            $numRecords = $PDO->query("select count(*) from product where (product.c_code=5 or product.c_code=6 or product.c_code=7 or product.c_code=8 or product.c_code=9 or product.c_code=10 or product.c_code=11)")->fetchColumn();
            break;
        ...
        case 'face':
            ...
            $numRecords = $PDO->query("select count(*) from product where (product.c_code=18 or product.c_code=19 or product.c_code=20 or product.c_code=21 or product.c_code=22 or product.c_code=23)")->fetchColumn();
            break;
        ...
        case 'hair':
            ...
            $numRecords = $PDO->query("select count(*) from product where (product.c_code=24 or product.c_code=25 or product.c_code=26 or product.c_code=27 or product.c_code=28 or product.c_code=29)")->fetchColumn();
            break;
        ...
        case 'makeup':
            ...
            $numRecords = $PDO->query("select count(*) from product where (product.c_code=35 or product.c_code=30 or product.c_code=31 or product.c_code=32 or product.c_code=33 or product.c_code=34)")->fetchColumn();
            break;
        ...
        case 'perfume':
            ...
            $numRecords = $PDO->query("select count(*) from product where (product.c_code=36 or product.c_code=37 or product.c_code=38 or product.c_code=39 or product.c_code=40 or product.c_code=41)")->fetchColumn();
            break;
        ...
        case 'gift':
            ...
            $numRecords = $PDO->query("select count(*) from product where (product.c_code=42 or product.c_code=43 or product.c_code=44 or product.c_code=45 or (product.r_price >= 10000 and product.r_price <= 39999) or (product.r_price >= 40000 and product.r_price <= 69999) or product.r_price >= 70000)")->fetchColumn();
            break;
        ...
        case 'vegan':
            ...
            $numRecords = $PDO->query("select count(*) from product where p_img2 like '%null(19)%'")->fetchColumn();
            break; 
    }
